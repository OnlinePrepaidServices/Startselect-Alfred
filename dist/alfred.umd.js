...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;__webpack_require__(4114);
/*
  ...
  function fuzzysortNew(instanceOptions) {
    var fuzzysort = {
        ...
        if (options && options.keys) {
          ...
          for (var i = targetsLen - 1; i >= 0; --i) {
            ...
            for (var keyI = keysLen - 1; keyI >= 0; --keyI) {
              ...
              if (!isObj(target)) target = fuzzysort.getPrepared(target);
              if ((searchBitmask & target._bitmask) != searchBitmask) objResults[keyI] = null;else objResults[keyI] = fuzzysort.algorithm(searchLowerCodes, target, searchLower);
            }
          ...
          for (var i = targetsLen - 1; i >= 0; --i) {
            ...
            if (!target) continue;
            if (!isObj(target)) target = fuzzysort.getPrepared(target);
            if ((searchBitmask & target._bitmask) != searchBitmask) var result = null;else var result = fuzzysort.algorithm(searchLowerCodes, target, searchLower);
      ...
      prepare: function (target) {
        ...
        return {
          target: target,
          _targetLower: target.toLowerCase(),
          _targetLowerCodes: lowerCodes,
          _nextBeginningIndexes: null,
          _bitmask: fuzzysort.prepareBitmask(lowerCodes),
          score: null,
          indexes: [0],
          obj: null
        }; // hidden
      },
      /*deprecated*/prepareSlow: function (target) {
      ...
      prepareSearch: function (search) {
        ...
        return {
          ...
          bitmask: fuzzysort.prepareBitmask(lowerCodes)
        };
      },
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./resources/js/components/Alfred.vue?vue&type=template&id=3cb420e1
  ...
  return _vm.alfred.visible ? _c('div', {
    ...
    on: {
      "input": function ($event) {
        ...
        _vm.$set(_vm.alfred, "phrase", $event.target.value);
      }
    }
  }), _c('div', {
    staticClass: "alfred__search__extended"
  }, [_c('span', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: _vm.alfred.loading,
      expression: "alfred.loading"
    }],
    staticClass: "alfred__loader alfred__search__extended__loader"
  }), _c('button', {
    on: {
      "click": function ($event) {
        return _vm.triggerAction($event);
      }
    }
  }, [_c('i', {
    ...
    staticClass: "alfred__loader alfred__search__loader"
  })])]), _c('div', {
    staticClass: "alfred__messages"
  }, [_c('ul', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: _vm.messages.current.length,
      expression: "messages.current.length"
    }]
  }, _vm._l(_vm.messages.current, function (message) {
    return _c('li', {
      class: message.type === 'success' ? 'alfred__message--success' : 'alfred__message--error',
      domProps: {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: _vm.tips.current.length && !_vm.getPhrase(),
      expression: "tips.current.length && !getPhrase()"
    }],
    ...
    ref: "items"
  }, _vm._l(_vm.items.filtered, function (item) {
    return _c('li', {
      ...
      staticClass: "alfred__item__content"
    }, [_c('span', {
      staticClass: "alfred__item__name"
    }, [_c('span', {
      domProps: {
        "innerHTML": _vm._s(item.name)
      }
    }), item.usage > 0 ? _c('span', {
      staticClass: "alfred__item__usage",
      attrs: {
        "title": 'Used ' + item.usage + ' times'
      }
    }, [_c('i', {
      staticClass: "fas fa-star"
    }), _vm._v(" " + _vm._s(item.usage) + " ")]) : _vm._e(), item.warn ? _c('i', {
    ...
    })]), item.type !== 'FallbackItem' && (item.shortcut || item.prefix || item.type === 'StatusItem' || item.type === 'ImageItem') ? _c('div', {
      staticClass: "alfred__item__details"
    }, [item.type === 'ImageItem' ? _c('span', [_c('span', {
      staticClass: "alfred__item__details__image"
    }, [_c('img', {
      attrs: {
        "src": item.image,
        "alt": ""
      }
    })])]) : _vm._e(), item.type === 'StatusItem' ? _c('span', [_c('span', {
      staticClass: "alfred__item__details__status",
      style: {
        color: item.color
      }
    }, [_vm._v(_vm._s(item.status))])]) : _vm._e(), item.shortcut ? _c('ul', _vm._l(item.shortcut, function (button) {
      return _c('li', [_vm._v(" " + _vm._s(button === 'ctrl' && _vm.isMacOs ? '⌘' : button) + " ")]);
...
;// ./resources/js/components/Alfred.vue?vue&type=template&id=3cb420e1
...
var fuzzysort = __webpack_require__(1192);
var fuzzysort_default = /*#__PURE__*/__webpack_require__.n(fuzzysort);
// EXTERNAL MODULE: ./node_modules/sweetalert2/dist/sweetalert2.all.js
var sweetalert2_all = __webpack_require__(656);
...
/* harmony default export */ var Alfredvue_type_script_lang_js = ({
  props: {
    settings: {
      type: Object,
      required: false
  ...
  methods: {
    ...
    updateAlfredState(state) {
      ...
      if ((state.tips || null) && this.getSetting(settings.DISPLAY_TIPS, true)) {
     ...
     */
    getPhrase() {
      return this.alfred.prefixed && this.alfred.prefix ? this.alfred.phrase.substring(this.alfred.prefix.length + 1) : this.alfred.phrase;
    },
    /**
    ...
    setLocalStorageData(key, data, ttl) {
      ...
      if ((ttl || 0) !== 0) {
        data = data.concat({
          expiration: currentTimestamp + ttl
        });
      }
    ...
    filterItems() {
      ...
      if (!this.items.current.length) {
        ...
        this.items.title = this.action.active && !this.action.realtime && !this.alfred.prefixed ? '' : this.getSetting(settings.TITLE_ITEMS_EMPTY, 'No results');
        return;
      }
      ...
      let filtered = fuzzysort_default().go(this.getPhrase(), this.items.current, {
        keys: ['name', 'info'],
        limit: 100,
        scoreFn: a => {
      ...
      if (!this.items.saved.length && !filtered.length && this.alfred.phrase) {
        ...
        this.items.title = this.getSetting(settings.TITLE_ITEMS_FALLBACK, 'Use [phrase] with..').replace('[phrase]', "'" + this.alfred.phrase + "'");
        return;
      }
      ...
      if (!this.items.saved.length && !filtered.length && !this.getPhrase() && !this.alfred.initiatedGlobally && this.getSetting(settings.REMEMBER_POPULAR_ITEMS, false)) {
        // Get current item usages
        ...
        this.items.title = this.getSetting(settings.TITLE_ITEMS_POPULAR, 'Recent searches');
        return;
      }
      ...
      if (this.items.saved.length && !filtered.length && this.getPhrase()) {
        ...
        this.items.title = this.getSetting(settings.TITLE_ITEMS_EMPTY, 'No results');
        return;
      }

      // Render fuzzy filtered items
      this.renderItems(filtered, false, []);
      this.items.title = !this.items.saved.length && !filtered.length && !this.getPhrase() && !this.alfred.initiatedGlobally ? '' : this.getSetting(settings.TITLE_ITEMS_RESULTS, 'Results');
    },
    /**
        ...
        if (fallback) {
          ...
          if (filteredItem[0] !== null) {
            if (filteredItem[0].target === info) {
              info = fuzzysort_default().highlight(filteredItem[0]);
            } else {
              name = fuzzysort_default().highlight(filteredItem[0]);
            }
          } else if (filteredItem[1] !== null) {
            if (filteredItem[1].target === info) {
              info = fuzzysort_default().highlight(filteredItem[1]);
            } else {
              name = fuzzysort_default().highlight(filteredItem[1]);
            }
          } else {
            continue;
          }
    ...
    triggerPrefixedItem(item) {
      ...
      if (this.getSetting(settings.REMEMBER_POPULAR_ITEMS, false)) {
    ...
    triggerRedirect(redirect, event) {
      ...
      if (redirect.type === 'ajax') {
        ...
        lib_axios.post(redirect.url, {}).then(response => {
          // No longer loading
    ...
    handleItemAutocomplete(item) {
      ...
      if (newPhrase.length) {
        this.alfred.phrase = this.alfred.prefixed && this.alfred.prefix ? this.alfred.prefix + ' ' + newPhrase.join(' ') : newPhrase.join(' ');
      }
    },
    /**
     * Handle item trigger.
    ...
    handlePreparedTrigger(trigger, event, alfredState) {
      ...
      if (trigger.type === 'ItemSet') {
        ...
        if (this.action.active && (this.action.realtime || this.alfred.prefixed) && !this.action.realtimeShouldDeactivate) {
...
;// ./resources/js/components/Alfred.vue
...
var component = normalizeComponent(
  components_Alfredvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var Alfred = (component.exports);
...
/* harmony default export */ var install = (AlfredApp);
...
//# sourceMappingURL=alfred.umd.js.map